                  ...
                  <div class="card-block pt-5">
                    ...
                    <ul class="list-inline text-center mt-20 mb-0">
                      <li class="list-inline-item">
                        <i class="icon wb-large-point indigo-600 mr-10" aria-hidden="true"></i>전체 응답
                      </li>
                      <li class="list-inline-item ml-35">
                        <i class="icon wb-large-point teal-600 mr-10" aria-hidden="true"></i>응답 성공
                      </li>
                      <li class="list-inline-item ml-35">
                        <i class="icon wb-large-point red-600 mr-10" aria-hidden="true"></i>응답 실패
                      </li>
                    </ul>
                  </div>
                </div>
...
<!--                </div>-->
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 ">
                  ...
                  <div class="row mt-10">
                    <div class="col-sm-12 col-md-5">
                      <select v-model="itemRange" @change="toggleItemRange"
                              class="form-control float-left w-100 mr-10">
                      ...
                      <div class="dataTables_paginate paging_simple_numbers float-right" id="DataTables_Table_0_paginate">
                        <ul class="pagination">
                          ...
                          <li class="paginate_button page-item">
                            <a href="#" aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0" class="page-link" >${idx}</a>
                          </li>
                          <li class="paginate_button page-item">
                            <a href="#" aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0" class="page-link" >${idx}</a>
                          </li>
  ...
  <script>
    (function (global, factory) {
      ...
      $("#inputStartDate").datepicker().datepicker("setDate", lastMonth());
      $("#inputEndDate").datepicker().datepicker("setDate", today());
      ...
      (0, _jquery.default)(document).ready(function ($$$1) {
        ...
        new Chartist.Line("#widgetChatbot .ct-chart", {
          ...
          series: [[100, 50, 70, 110, 100, 200, 230], [80, 40, 60, 90, 90, 190, 140], [20, 10, 10, 20, 10, 10, 90]]
        }, {
          low: 0,
          showArea: true,
          showPoint: true,
