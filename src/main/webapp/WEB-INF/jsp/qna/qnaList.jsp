...
<script type="text/javascript">
	...
	function insertQnaReply() {
		var request = $.ajax({ url : "/qna/insertQnaReply.do", method : "post",
	...
	function updateQnaReply() {
		var request = $.ajax({ url : "/qna/updateQnaReply.do", method : "post",
		//contentType: "application/json",
		//dataType: "json",
	...
	function deleteQnaReply() {
		var request = $.ajax({ url : "/qna/deleteQnaReply.do", method : "post",
		//contentType: "application/json",
		//dataType: "json",
		data : $("#qna-modal-update-form").serialize() });
		request.done(function(data) {
				...
				.jsGrid(
						{
							...
							fields : [
									...
									{ title : "제목", type : "text", width : 200, itemTemplate : function(_, item) {
	...
	function getQnaList() {
		var request = $.ajax({ url : "/qna/getQnaList.do", method : "get", data : $("#search-form").serialize() });
	...
	function increaseViewCount(qna_idx) {
		var request = $.ajax({ url : "/qna/increaseViewCount.do?qna_idx=" + qna_idx, method : "get" });
