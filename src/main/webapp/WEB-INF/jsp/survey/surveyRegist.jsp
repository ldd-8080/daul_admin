					...
					<div class="panel-body">
						<form:form method="post" modelAttribute="surveyVo" enctype="multipart/form-data">
							...
							<div class="form-group row">
								...
								<div class="col-md-8">
									<input type="file" accept="image/*" id="input-file-now-custom-1" name="repFile" id="surveyFile" data-plugin="dropify" data-default-file="${pageContext.request.contextPath}/img/placeholder.png" />
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-1"></div>
