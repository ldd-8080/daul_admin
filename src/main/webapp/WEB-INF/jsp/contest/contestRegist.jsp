...
<div class="page">
	<div class="page-content container-fluid">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">공모등록</li>
		</ol>
		<div class="col-lg-12">
			<div class="mb-30">
				<div class="panel">
					<div class="panel-body">
						<form:form method="post" modelAttribute="contestVo" enctype="multipart/form-data">
							...
							<div class="form-group row">
								...
								<div class="col-md-8">
									<input type="file" accept="image/*" id="repFile" name="repFile" data-plugin="dropify" data-default-file="${pageContext.request.contextPath}/img/placeholder.png" />
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-1"></div>
							...
							<div class="form-group row">
								<div class="col-md-1"></div>
								<label class="col-md-2 col-form-label">접수기간 </label>
								<div class="col-md-6 col-xl-4">
									<div class="input-daterange" data-plugin="datepicker">
										<div class="input-group">
											<div class="input-group-prepend">
							...
							<div class="form-gorup row mb-20">
								...
								<div class="col-md-8">
									<div id="contestFileName-list"></div>
								</div>
							</div>
							<div class="form-gorup row mb-20">
								<div class="col-md-1"></div>
...
<script type="text/javascript">
	...
	function propFileChange() {
		...
		for (var i = 0; i < fileValue.length; i++) {
			var exist = false;
			for (var j = 0; j < propFileList.length; j++) {
